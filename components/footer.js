...
const SERVICE_LINKS = [
  {
    ...
    links: [
      ...
      { href: "/retirement-planning-vadodara", label: "Retirement Planning" },
      ...
      { href: "/insurance-planning-vadodara", label: "Insurance Planning" },
    ],
  },
  {
    header: "Investments",
    links: [
      { href: "/mutual-fund-investment-support-vadodara", label: "Mutual Fund Support" },
      { href: "/fixed-income-investments-vadodara", label: "Fixed Income" },
...
const EXPLORE_LINKS = [
  ...
  { href: "/portfolio-review-vadodara", label: "Portfolio Review" },
